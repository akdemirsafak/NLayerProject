...
namespace NLayer.Repository.Migrations
{
    ...
    [Migration("20220726075214_Initial")]
            ...
            modelBuilder.Entity("NLayer.Core.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 7, 26, 10, 52, 14, 451, DateTimeKind.Local).AddTicks(2550),
                            Name = "Kurşun Kalem",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 7, 26, 10, 52, 14, 451, DateTimeKind.Local).AddTicks(2570),
                            Name = "Tükenmez Kalem",
                            Price = 150m,
                            Stock = 50
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2022, 7, 26, 10, 52, 14, 451, DateTimeKind.Local).AddTicks(2580),
